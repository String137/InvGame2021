...
const RedirectionOTBase = (props) => {
    ...
    return (
        <>
            ...
            <div className="wait-text">OT 영상을 시청해주세요.</div>
        </>
    );
}

const RedirectionOT = withRouter(withFirebase(RedirectionOTBase));
export default RedirectionOT;