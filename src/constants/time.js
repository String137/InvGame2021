...
export const ROUND1_VIDEO = 60 * 1000;
export const ROUND1_INVEST = 1 * 60 * 1000;
export const ROUND2_VIDEO = 6000 * 1000;
export const ROUND2_INVEST = 1 * 60 * 1000;
export const ROUND3_VIDEO = 60 * 1000;
export const ROUND3_INVEST = 1 * 60 * 1000;
export const FINAL_VIDEO = 60 * 1000;
export const FINAL_INVEST = 1 * 60 * 1000;
export const FINAL_REDIRECTION = 60 * 1000;
export const START_TIME = new Date('January 22, 2021 01:35:00').getTime();
